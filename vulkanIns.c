...
static const struct Vertexa g_vbDataCube[] = {
    ...
    {XYZ1(-1, 1, -1), XYZ1(0.f, 1.f, 0.f), XYZ1(0.f, 0.f, -1.f)},
    {XYZ1(1, -1, -1), XYZ1(1.f, 0.f, 0.f), XYZ1(0.f, 0.f, -1.f)},
    {XYZ1(1, 1, -1), XYZ1(1.f, 1.f, 0.f), XYZ1(0.f, 0.f, -1.f)},

    {XYZ1(-1, -1, 1), XYZ1(0.f, 0.f, 1.f), XYZ1(0.f, 0.f, 1.f)},
    {XYZ1(-1, 1, 1), XYZ1(0.f, 1.f, 1.f), XYZ1(0.f, 0.f, 1.f)},
    {XYZ1(1, -1, 1), XYZ1(1.f, 0.f, 1.f), XYZ1(0.f, 0.f, 1.f)},
    {XYZ1(1, -1, 1), XYZ1(1.f, 0.f, 1.f), XYZ1(0.f, 0.f, 1.f)},
    {XYZ1(-1, 1, 1), XYZ1(0.f, 1.f, 1.f), XYZ1(0.f, 0.f, 1.f)},
    {XYZ1(1, 1, 1), XYZ1(1.f, 1.f, 1.f), XYZ1(0.f, 0.f, 1.f)},

    {XYZ1(1, 1, 1), XYZ1(1.f, 1.f, 1.f), XYZ1(1.f, 0.f, 0.f)},
    {XYZ1(1, 1, -1), XYZ1(1.f, 1.f, 0.f), XYZ1(1.f, 0.f, 0.f)},
    {XYZ1(1, -1, 1), XYZ1(1.f, 0.f, 1.f), XYZ1(1.f, 0.f, 0.f)},
    {XYZ1(1, -1, 1), XYZ1(1.f, 0.f, 1.f), XYZ1(1.f, 0.f, 0.f)},
    {XYZ1(1, 1, -1), XYZ1(1.f, 1.f, 0.f), XYZ1(1.f, 0.f, 0.f)},
    {XYZ1(1, -1, -1), XYZ1(1.f, 0.f, 0.f), XYZ1(1.f, 0.f, 0.f)},

    {XYZ1(-1, 1, 1), XYZ1(0.f, 1.f, 1.f), XYZ1(-1.f, 0.f, 0.f)},
    {XYZ1(-1, -1, 1), XYZ1(0.f, 0.f, 1.f), XYZ1(-1.f, 0.f, 0.f)},
    {XYZ1(-1, 1, -1), XYZ1(0.f, 1.f, 0.f), XYZ1(-1.f, 0.f, 0.f)},
    {XYZ1(-1, 1, -1), XYZ1(0.f, 1.f, 0.f), XYZ1(-1.f, 0.f, 0.f)},
    {XYZ1(-1, -1, 1), XYZ1(0.f, 0.f, 1.f), XYZ1(-1.f, 0.f, 0.f)},
    {XYZ1(-1, -1, -1), XYZ1(0.f, 0.f, 0.f), XYZ1(-1.f, 0.f, 0.f)},

    {XYZ1(1, 1, 1), XYZ1(1.f, 1.f, 1.f), XYZ1(0.f, 1.f, 0.f)},
...
//Setup the depth buffer:
  ...
  char *vertexShader = readBinaryFile("shaders/ins/vert.spv", &vertexShaderSize);
  size_t fragmentShaderSize=0;
  char *fragmentShader = readBinaryFile("shaders/ins/frag.spv", &fragmentShaderSize);
...
//   //vkUnmapMemory(device, uniformMemory);
  ...
  for (int i = 0; i < 3; i++)
  {
      ...
      vertexInputAttributeDescription[i].format = VK_FORMAT_R32G32B32A32_SFLOAT;
      vertexInputAttributeDescription[i].offset = i*16;
  }
